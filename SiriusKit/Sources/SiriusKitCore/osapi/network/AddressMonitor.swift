...
public class AddressMonitor: ObservableObject {
    ...
    @Published
    public var currentAddresses: [IPAddress] = []
    ...
    init() {
        ...
        self.currentAddresses = AddressMonitor.getInterfaceAddresses()
        ...
        self.monitor.pathUpdateHandler = { [weak self] path in
            ...
            let addresses = AddressMonitor.getInterfaceAddresses(orderedBy: orderedInterfaceNames)
    ...
    private static func getInterfaceAddresses() -> [IPAddress] {
    ...
    private static func getInterfaceAddresses(orderedBy interfaceNames: [String]) -> [IPAddress] {
