            ...
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading) {
                    ...
                    VStack {
                        HStack {
                            Button {
                                openURL(URL(string: "https://noctiluca.app/docs/eula/server")!)
                            } label: {
                                Text(markdown: String(localized: "about.terms_of_service", defaultValue: "사용권 계약"))
                            }

                            Button {
                                openURL(URL(string: "https://noctiluca.app/docs/open-sources/server")!)
                            } label: {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text(
                            markdown: String(
                                ...
                                defaultValue: "안녕하세요, 저희는 대한민국 경기도 안산에 위치한 영세한 소프트웨어 개발 업체인 **주식회사 팀언스테이블러즈** (team unstablers Inc.) 입니다. \n\n저희는 \"여러분들의 꿈을 이루어 드립니다\" 라는 모토 아래, 많은 클라이언트들이 이루지 못한 기술적 난제를 주로 해결해오곤 했습니다. 저희가 가장 잘 하는 것이 컴퓨터였기에, 기술로 사람들을 돕는 일을 계속 해왔습니다.\n\n하지만, 오랜 불경기 속에서 회사의 지속이 어려워졌습니다.\n\nNoctiluca / Sirius는 그런 와중에 제가 바닥부터 구상하고 실현할 수 있었던 몇 안되는 프로젝트 중 하나였습니다. 몇 년 가까이 생각을 구체화 하면서, 처음으로 여러분께 선보일 수 있게 된 것을 자랑스럽게 생각하고 있습니다.\n\n저희는 부자가 되고 싶지 않습니다. 그저 매일마다 생존에 대한 걱정 없이 컴퓨터 프로그래밍을 하고 싶을 뿐입니다.\n\n감사합니다."
                            )
                        )
                            .fixedSize(horizontal: false, vertical: true)
                    }
