...
public struct PluginBundleManifestV1Draft: PluginBundleManifest, Codable {
    /// JSON Schema 의 `pluginKitVersion` 식별자.
    public static let pluginKitVersionTag: String = "20260516"

    public let schemaURL: String?

    public let id: String
    public let name: NocPluginLocalizableString
    public let bundleDescription: NocPluginLocalizableString
    ...
    public let pluginKitVersion: NoctilucaPluginKitVersion
    public let isolationPolicy: PluginIsolationPolicy
    public let exports: [NocPluginManifest]
