...
public enum NoctilucaPluginType: String, Codable, Sendable {
    ...
    /// RPC 핸들러. Sirius 프로토콜의 'simplerpc' 핸들러를 제공하여 기능을 확장할 수 있도록 합니다.
    case rpcHandler = "rpc_handler"
...
public enum NoctilucaPluginExport: Sendable {
    ...
    case rpcHandler(RPCHandlerPluginV1)
