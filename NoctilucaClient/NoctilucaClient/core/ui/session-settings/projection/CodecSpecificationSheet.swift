            ...
            Form {
                Section {
                    Picker(selection: $specification.options[.hardwareAcceleration]) {
                        Text(String(localized: "common.auto", defaultValue: "자동"))
                            .tag(CodecOptionValue.kHardwareAccelerationAuto)
                        Text(String(localized: "session-settings.projection.codec.hw_accel.disabled", defaultValue: "사용 안 함"))
                            .tag(CodecOptionValue.kHardwareAccelerationFalse)
                    } label: {
                        Text(String(localized: "session-settings.projection.codec.hw_accel", defaultValue: "하드웨어 가속"))
                        switch specification.options[.hardwareAcceleration] {
                        case .kHardwareAccelerationAuto:
                            Text(String(localized: "session-settings.projection.codec.hw_accel.auto_desc", defaultValue: "서버가 환경에 맞춰 하드웨어 가속 사용 여부를 자동으로 결정합니다."))
                        case .kHardwareAccelerationFalse:
                            Text(String(localized: "session-settings.projection.codec.hw_accel.disabled_desc", defaultValue: "서버에게 하드웨어 가속 사용을 요청합니다.\n참고: 옵션 이름은 legacy 호환성 때문에 false로 표시됩니다."))
                        default:
                            Text(String(localized: "session-settings.projection.codec.hw_accel.default_desc", defaultValue: "서버 인코딩의 하드웨어 가속 요청 정책을 설정합니다."))
                        }
                    }
                    ...
                    Picker(selection: $specification.options[.colorFormat]) {
                        ...
                        Text(String(localized: "session-settings.projection.codec.color_format", defaultValue: "색상 포맷"))
                        switch specification.options[.colorFormat] {
                        case .kColorFormatAuto:
                            Text(String(localized: "session-settings.projection.codec.color_format.auto_desc", defaultValue: "최적의 색상 포맷을 자동으로 선택합니다."))
                        case .kColorFormatYUV420:
                            Text(String(localized: "session-settings.projection.codec.color_format.yuv420_desc", defaultValue: "YUV 4:2:0 색상 포맷을 사용합니다. 대부분의 기기에서 호환됩니다."))
                        case .kColorFormatYUV444:
                            Text(String(localized: "session-settings.projection.codec.color_format.yuv444_desc", defaultValue: "YUV 4:4:4 색상 포맷을 사용합니다.\n텍스트 가독성이 향상되지만, 대역폭 사용량이 늘어나고 호환성이 떨어질 수 있습니다."))
                        default:
                            Text(String(localized: "session-settings.projection.codec.color_format.default_desc", defaultValue: "색상 포맷을 설정합니다."))
                        }
                    }

                    Picker(selection: $specification.options[.colorRange]) {
                        Text(String(localized: "session-settings.projection.codec.color_range.limited", defaultValue: "제한됨"))
                            .tag(CodecOptionValue.kColorRangeLimited)

                        Text(String(localized: "session-settings.projection.codec.color_range.full", defaultValue: "전체"))
                            .tag(CodecOptionValue.kColorRangeFull)
                    } label: {
                        Text(String(localized: "session-settings.projection.codec.color_range", defaultValue: "색상 범위"))
                        ...
                        default:
                            Text(String(localized: "session-settings.projection.codec.color_range.default_desc", defaultValue: "색상 범위를 설정합니다."))
                        }
                    }
                    ...
                    Picker(selection: $specification.options[.profile]) {
                        ...
                        Text(String(localized: "session-settings.projection.codec.profile", defaultValue: "코덱 프로파일"))
                        switch specification.options[.profile] {
                        case .kProfileAuto:
                            Text(String(localized: "session-settings.projection.codec.profile.auto_desc", defaultValue: "최적의 코덱 프로파일을 자동으로 선택합니다."))
                        case .kProfileH264Baseline:
                            Text(String(localized: "session-settings.projection.codec.profile.h264_baseline_desc", defaultValue: "호환성이 높은 Baseline Profile을 사용합니다.\n코덱의 고급 기능을 사용할 수 없기 때문에 압축률과 화질이 낮습니다."))
                        case .kProfileH264Main:
                            Text(String(localized: "session-settings.projection.codec.profile.h264_main_desc", defaultValue: "Main Profile을 사용합니다.\n대부분의 기기에서 적절한 호환성과 압축률을 제공합니다."))
                        case .kProfileH264High:
                            Text(String(localized: "session-settings.projection.codec.profile.h264_high_desc", defaultValue: "High Profile을 사용합니다.\n고급 기능을 사용하여 최고의 압축률과 화질을 제공합니다."))
                        case .kProfileHEVCMain:
                            Text(String(localized: "session-settings.projection.codec.profile.hevc_main_desc", defaultValue: "Main Profile을 사용합니다.\n대부분의 기기에서 적절한 호환성과 압축률을 제공합니다."))
                        case .kProfileHEVCMain10:
                            Text(String(localized: "session-settings.projection.codec.profile.hevc_main10_desc", defaultValue: "Main10 Profile을 사용합니다.\n10-bit 색상 지원으로 더 풍부한 색상을 제공합니다."))
                        default:
                            Text(String(localized: "session-settings.projection.codec.profile.default_desc", defaultValue: "코덱 프로파일을 설정합니다."))
                        }
                    }
                    ...
                    Picker(selection: $specification.options[.dynamicRange]) {
                        ...
                        Text(String(localized: "session-settings.projection.codec.dynamic_range", defaultValue: "다이나믹 레인지"))
                        switch specification.options[.dynamicRange] {
                        case .kDynamicRangeSDR:
                            Text(String(localized: "session-settings.projection.codec.dynamic_range.sdr_desc", defaultValue: "표준 다이나믹 레인지를 사용합니다."))
                        case .kDynamicRangeHDR:
                            Text(String(localized: "session-settings.projection.codec.dynamic_range.hdr_desc", defaultValue: "사용 가능한 경우 HDR 다이나믹 레인지를 사용합니다."))
                        default:
                            Text(String(localized: "session-settings.projection.codec.dynamic_range.default_desc", defaultValue: "다이나믹 레인지를 설정합니다."))
                        }
                ...
                Section {
                    SettingsEntry(
                        ...
                        Slider(
                            ...
                            step: 1,
                            minimumValueLabel: Text(String(localized: "common.auto", defaultValue: "자동")),
                ...
                Section {
                    Picker(selection: $specification.options[.displayDensity]) {
                        ...
                        Text(String(localized: "session-settings.projection.codec.display_density.performance", defaultValue: "성능 우선"))
                            .tag(CodecOptionValue.kDisplayDensityPerformance)

                        Text(String(localized: "session-settings.projection.codec.display_density.best", defaultValue: "화질 우선"))
                            .tag(CodecOptionValue.kDisplayDensityBest)
                    } label: {
                        Text(String(localized: "session-settings.projection.codec.display_density", defaultValue: "디스플레이 밀도"))
                        switch specification.options[.displayDensity] {
                        case .kDisplayDensityAuto:
                            Text(String(localized: "session-settings.projection.codec.display_density.auto_desc", defaultValue: "디스플레이 밀도를 자동으로 선택합니다."))
                        case .kDisplayDensityPerformance:
                            Text(String(localized: "session-settings.projection.codec.display_density.performance_desc", defaultValue: "성능을 우선시하여 디스플레이 밀도를 설정합니다.\n대부분의 경우 1x 밀도로 설정됩니다."))
                        case .kDisplayDensityBest:
                            Text(String(localized: "session-settings.projection.codec.display_density.best_desc", defaultValue: "HIDPI / Retina 디스플레이 밀도를 사용하려 노력합니다.\n더 나은 화질을 제공하지만, 높은 대역폭과 컴퓨팅 자원을 사용합니다."))

                        default:
                            Text(String(localized: "session-settings.projection.codec.display_density.default_desc", defaultValue: "디스플레이 밀도를 설정합니다."))
                        }
                    }
                }
            }
...
fileprivate extension CodecSpecificationSheet {
    ...
    func h264ProfileOptions() -> some View {
        Text(String(localized: "session-settings.projection.codec.profile.h264_baseline", defaultValue: "Baseline Profile (가장 높은 호환성, 압축률 낮음)"))
            .tag(CodecOptionValue.kProfileH264Baseline)
        Text("Main Profile")
            .tag(CodecOptionValue.kProfileH264Main)
        Text(String(localized: "session-settings.projection.codec.profile.h264_high", defaultValue: "High Profile (가장 낮은 호환성, 압축률 높음)"))
    ...
    func hevcProfileOptions() -> some View {
        ...
        Text(String(localized: "session-settings.projection.codec.profile.hevc_main10", defaultValue: "Main10 Profile (10-bit 색상 지원)"))
