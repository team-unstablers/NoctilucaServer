...
struct VP8CodecSpecificationSheet: View {
            ...
            Form {
                Section {
                    Picker(selection: $specification.options[.hardwareAcceleration]) {
                        ...
                        Text(markdown: String(localized: "settings.projection.codec_sheet.hardware_acceleration.description_disabled", defaultValue: "이 코덱은 하드웨어 가속 인코딩을 지원하지 않습니다."))
                    }
...
private extension VP8CodecSpecificationSheet {
    @ViewBuilder
