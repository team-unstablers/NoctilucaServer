...
struct MetalCursorView: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: MTKView, context: Context) {
        ...
        context.coordinator?.updateCursorState(cursorState, sourceSize: sourceSize, in: nsView)
    }
}
#endif
...
struct MetalCursorView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: MTKView, context: Context) {
        context.coordinator?.updateCursorState(cursorState, sourceSize: sourceSize, in: uiView)
    }
}
#endif
