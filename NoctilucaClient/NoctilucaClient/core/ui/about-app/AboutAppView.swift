            ...
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading) {
                    VStack(alignment: .leading) {
                        ...
                        Text("버전 \(NoctilucaMeta.version) (\(NoctilucaMeta.buildVersion))")
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Group {
                            ...
                            Text("이 소프트웨어는 오픈 소스 소프트웨어를 포함합니다. 자세한 사항은 아래 '오픈 소스 라이선스' 버튼을 눌러 확인할 수 있습니다.")
                        }
                        .font(.caption)
                        .foregroundStyle(.secondary)
                    }
