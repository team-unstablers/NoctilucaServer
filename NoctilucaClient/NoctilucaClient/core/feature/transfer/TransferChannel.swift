...
final class TransferChannel: Channel, ChannelEventConsumer {
    ...
    // MARK: 진행률 콜백. 한 번 설정된 후 변경되지 않으므로 nonisolated(unsafe) 허용.
    nonisolated(unsafe) var onTransferStarted: (@Sendable (_ channelID: UUID, _ totalSize: UInt64) -> Void)? = nil
    nonisolated(unsafe) var onProgressUpdate: (@Sendable (_ channelID: UUID, _ additionalBytes: UInt64) -> Void)? = nil
