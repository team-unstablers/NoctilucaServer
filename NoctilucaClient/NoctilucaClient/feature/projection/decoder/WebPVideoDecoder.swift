...
final class WebPVideoDecoder: VideoDecoder {
    ...
    init() {
        self.workerQueue = DispatchQueue(label: "pl.unstabler.noctiluca.decoder.webp.worker")
        self.callbackQueue = DispatchQueue(label: "pl.unstabler.noctiluca.decoder.webp.callback")
    }
